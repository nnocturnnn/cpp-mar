...
template <typename T>
auto outputWeird3Arguments = std::bind(output3Arguments<std::string>, std::placeholders::_2, std::placeholders::_3, std::placeholders::_1);
auto outputFusRoDah = std::bind(output3Arguments<std::string>, "Fus", "Ro", "Dah");
auto outputLovelyWords = std::bind(output3Arguments<std::string>, "I", "love", "you !");
}
}
