...
void TestIntexOf()
{
    ...
    ASSERT_EQUAL(IndexOf(v, 10), static_cast<int>(v.size()));
    ASSERT_EQUAL(IndexOf(l, 10), static_cast<int>(l.size()));
...
void TestIntexOfPred()
{
    ...
    ASSERT_EQUAL(IndexOfIf(v, [](const auto &a) { return a == 10; }), static_cast<int>(v.size()));
    ASSERT_EQUAL(IndexOfIf(l, [](const auto &a) { return a == 10; }), static_cast<int>(l.size()));
